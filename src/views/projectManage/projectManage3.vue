					...
					<el-table :data="tableData" style="width: 100%">
						...
						<el-table-column prop="address" label="执行状态" min-width="100">
							<template slot-scope="scope">
								<span v-if="scope.row.type==1" style="color: #F4AB46;">未启动</span>
						...
						<el-table-column prop="address" label="操作">
							<template slot-scope="scope">
								<div v-if="scope.row.state=='1'">
									<el-button type="text" size="middle" style="color: #F4AB46;">驳回</el-button>
									<el-button @click="handleClick(scope.row)" type="text" style="color: #ABADB2;" size="middle">详情</el-button>
									<el-button type="text" size="middle" style="color: #F4AB46;">接收</el-button>
								</div>
								<div v-if="scope.row.state=='2'">
									<el-button type="text" @click="handleClick(scope.row)" size="middle" style="color: #18318C">详情</el-button>
								</div>
