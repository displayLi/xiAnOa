					...
					<el-table :data="tableData" style="width: 100%">
						...
						<el-table-column prop="address" label="执行状态" min-width="100">
							<template slot-scope="scope">
								...
								<span v-if="scope.row.type==3" style="color: #469F48;">已启动
						...
						<el-table-column prop="address" label="操作" align="right">
							<template slot-scope="scope">
								<div v-if="scope.row.state=='1'">
									<el-button type="text" size="middle" style="color: #DF4B3C;">重新推送</el-button>
									<el-button @click="handleClick(scope.row)" type="text" size="middle" style="color: #18318C;">详情</el-button>
								</div>
								<div v-if="scope.row.state=='2'">
									<el-button type="text" size="middle" style="color: #DF4B3C;">确认审核</el-button>
									<el-button @click="handleClick(scope.row)" type="text" size="middle" style="color: #18318C;">详情</el-button>
								</div>
